...
public class PlayerHealth : MonoBehaviour
{
    ...
    [Tooltip("Optional sound that plays when the player takes damage")]
    ...
    public void SetUpHealth()
    {
        ...
        else
        {
            if (HealthBar)
            {
                ...
                //HealthBar.GetComponent<Image>().fillMethod = (int)Image.FillMethod.Vertical;
                //HealthBar.GetComponent<Image>().fillOrigin = (int)Image.OriginHorizontal.Left;
